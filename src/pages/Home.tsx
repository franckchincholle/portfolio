...
const projectCardsData = [
  {
    ...
    description:
      "Plateforme de recherche d'emploi (job board) développée en utilisant les technologies web fondamentales.",
  ...
  },
  {
    ...
    description:
      "Mon portfolio personnel que vous consultez actuellement, créé pour présenter mes compétences et mes projets.",
  ...
  },
  {
    ...
    description:
      "Plateformer 2D en Java avec gestion des collisions, animations et niveaux.",
    tech: ["Java", "libGDX"],
    status: "En ligne",
  ...
  },
  {
    ...
    description:
      "Jeu de dactylographie en Rust avec interface graphique et gestion des scores.",
    tech: ["Rust", "egui"],
    status: "En ligne",
  ...
  },
  {
    ...
    date: "26 Avril 2027",
    description:
      "Application de messagerie en temps réel intégrant des communications vidéo et le partage de GIF.",
    tech: ["TypeScript", "React", "Node.js"],
    status: "En ligne",
    link: "https://github.com/franckchincholle/ChatRTC",
  }
];
      ...
      if (!ticking) {
        window.requestAnimationFrame(() => {
          ...
          sectionElements.forEach((section) => {
            ...
            if (
              rect.top - containerTop <= 150 &&
              rect.bottom - containerTop >= 150
            ) {
    ...
    <div className="home">
      ...
      <aside className="left-content">
        ...
        <div className="social-icons">
          <a
            href="https://github.com/franckchincholle!"
            target="_blank"
      ...
      <main className="right-content" ref={scrollContainerRef}>
        ...
        <section id="about" className="section about">
          ...
          <p>
            Originaire de l'Aveyron, je suis depuis toujours passionnés par
            l'informatique et ces différentes branches. Portés par mon envie de
            découvrir un environnement en plein essor ainsi que par mon
            expérience personnelle je cherche à m'orienter dans la
            cybersécurité ou dans le développement informatique.
          </p>
          <p>
            Curieux, rigoureux et toujours motivé à apprendre, j’aime relever de
            nouveaux défis et travailler sur des projets concrets qui allient
            technique et créativité.
          </p>
          <p>
            Ayant obtenu mon BTS SIO option SISR en cet été 2025 et accepté à
            EPITECH Toulouse pour un Master of Science, je suis actuellement à
            la recherche d'une alternance en cybersécurité ou en tant que developpeur pour les 2 ans à
            venir à partir de Septembre 2026.
          </p>
        </section>
        ...
        <section id="entreprise" className="section about">
          ...
          <h3>Mission Micro</h3>
          <p>
            Mission Micro est une entreprise basée à Beauzelle, spécialisée dans
            les services informatiques adaptés aux besoins des entreprises et
            des particuliers. Depuis 2005, elle propose des solutions sur mesure
            en matière de réseaux, systèmes, sécurité informatique et télécoms.
            Son équipe polyvalente intervient sur des missions variées telles
            que l’assistance à maîtrise d’ouvrage, la maintenance, le
            déploiement de postes et la formation des utilisateurs. La
            collaboration durable entre Mission Micro et Collecte Localisation
            Satellite se poursuit aujourd’hui, avec pour mission d’assurer un
            support technique fiable et réactif aux utilisateurs de CLS.
          </p>
          <a
            href="https://www.agencemissionmicro.fr"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src="https://32c05b15c2.clvaw-cdnwnd.com/a5f998c5006027b58154b034ba58d825/200000000-d245ad3412/MM_logo1_carte%20de%20visite%20B.jpg?ph=32c05b15c2"
              alt="Logo MM"
              style={{ width: "60px", marginTop: "10px", marginBottom: "20px" }}
            />
          </a>
          <h3>Collecte Localisation Satellite</h3>
          <p>
            CLS est une entreprise française pionnière dans les solutions
            d'observation et de surveillance de la Terre depuis 1986. CLS
            déploie des services satellitaires innovants pour comprendre,
            protéger notre planète et gérer durablement ses ressources. Basée à
            Toulouse, elle opère dans plus de 30 pays et emploie environ 1 000
            collaborateurs. Ses domaines d'expertise couvrent la surveillance
            environnementale, la gestion durable des pêches, la sécurité
            maritime, la mobilité et les infrastructures énergétiques. CLS est
            également l'opérateur exclusif du système Argos, utilisé
            mondialement pour le suivi d'espèces, de flottes et de données
            environnementales.
          </p>
          <a
            href="https://www.cls.fr"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/b/be/Logo_CLS.jpg"
              alt="Logo CLS"
              style={{ width: "60px", marginTop: "5px", marginBottom: "5px" }}
            />
          </a>
        </section>
        ...
        <section id="veille" className="section about">
          ...
          <div className="veille-list">
            ...
            >
              <a
                href="https://www.th-formations-en-cybersecurite-et-informatique.fr"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>
                  Une plateforme dédiée aux formations en cybersécurité et
                  informatique, ainsi qu'une partie blog avec des articles
            ...
            >
              <a
                href="https://www.linkedin.com/groups/4880871/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>
                  LinkedIn est une plateforme professionnelle essentielle pour
                  le réseautage et la veille en cybersécurité. Des groupes comme
                  "Sécurité informatique, Cybersécurité & Protection des emails"
                  réunissent des experts partageant actualités, analyses et
                  solutions sur les cybermenaces.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>
                  Une communauté en ligne où les utilisateurs partagent et
                  discutent des actualités, des outils et des stratégies en
                  cybersécurité, notamment via des subreddits comme
                  r/cybersecurity.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>
                  Une plateforme vidéo mondiale où les créateurs partagent des
                  tutoriels, conférences et analyses sur la cybersécurité,
                  idéale pour apprendre et suivre les dernières tendances
                  techniques. Exemple : @Micode , @Underscore_
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>
                  Actu IA est un site français dédié à l’actualité de
                  l’intelligence artificielle, couvrant innovations, recherches
                  et applications. Il propose des articles, analyses et
                  interviews pour suivre les tendances de l’IA.
                </p>
              </div>
            </div>
          </div>
